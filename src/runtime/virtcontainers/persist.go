...
func (s *Sandbox) dumpConfig(ss *persistapi.SandboxState) {
	...
	ss.Config.HypervisorConfig = persistapi.HypervisorConfig{
		...
		VaccelPath:              sconfig.HypervisorConfig.VaccelPath,
		VaccelVsockPort:         sconfig.HypervisorConfig.VaccelVsockPort,
		VaccelHostBackends:      sconfig.HypervisorConfig.VaccelHostBackends,
		VaccelGuestBackend:      sconfig.HypervisorConfig.VaccelGuestBackend,
